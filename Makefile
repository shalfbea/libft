...
SRC_FILES = ft_strlen.c ft_strchr.c ft_strlcpy.c ft_strrchr.c ft_strncmp.c ft_strlcat.c ft_strnstr.c\
...
SRC_BONUS_FILES = ft_lstnew_bonus.c ft_lstadd_front_bonus.c ft_lstsize_bonus.c \
